...
export function getSeasonInfo(timestamp: number) {
...
export function getSeasonOnDate(date: Date): Season {
...
export function getNextSeasonOnDate(date: Date) {
	const dateTimestamp = Math.floor(date.getTime() / 1000)
...
export function getSeasonsBetweenDates(date1: Date, date2: Date): { season: Season; time: number }[] {
